*------------------------------------------------------------*;
* AutoNeural27: Create decision matrix;
*------------------------------------------------------------*;
data WORK.DepVar;
  length   DepVar                           $  32
           COUNT                                8
...
run;
*------------------------------------------------------------* ;
* AutoNeural27: DMDBClass Macro ;
*------------------------------------------------------------* ;
%macro DMDBClass;
    DepVar(DESC) G_Marital_Status(ASC)
%mend DMDBClass;
*------------------------------------------------------------* ;
* AutoNeural27: DMDBVar Macro ;
*------------------------------------------------------------* ;
%macro DMDBVar;
...
%mend DMDBVar;
*------------------------------------------------------------*;
* AutoNeural27: Create DMDB;
*------------------------------------------------------------*;
proc dmdb batch data=WORK.EM_AutoNeural27
dmdbcat=WORK.AutoNeural27_DMDB
maxlevel = 513
;
class %DMDBClass;
var %DMDBVar;
...
quit;
*------------------------------------------------------------* ;
* AutoNeural27: Interval Inputs Macro ;
*------------------------------------------------------------* ;
%macro INTINPUTS;
    AcceptedCmpTotal Frq Income Mnt MntGoldProds MntMeatProducts MntWines
   NumDistPurchases RFMstat RMntFrq Recency
%mend INTINPUTS;
*------------------------------------------------------------* ;
* AutoNeural27: Binary Inputs Macro ;
*------------------------------------------------------------* ;
%macro BININPUTS;

%mend BININPUTS;
*------------------------------------------------------------* ;
* AutoNeural27: Nominal Inputs Macro ;
*------------------------------------------------------------* ;
%macro NOMINPUTS;
    G_Marital_Status
%mend NOMINPUTS;
*------------------------------------------------------------* ;
* AutoNeural27: Ordinal Inputs Macro ;
*------------------------------------------------------------* ;
%macro ORDINPUTS;
...
*------------------------------------------------------------*;
*;
proc neural data=EM_AutoNeural27 dmdbcat=WORK.AutoNeural27_DMDB
...
run;
*;
data EMWS8.AutoNeural27_OUTFIT;
set _anfit;
...
proc print data=EMWS8.AutoNeural27_OUTFIT noobs;
var _iter_ _aic_ _averr_ _misc_
_vaverr_ _vmisc_
;
run;
...
data EMWS8.AutoNeural27_HISTORY;
...
*;
initial
inest = EMWS8.AutoNeural27_ESTDS bylabel;
;
*;
title9 " ";
...
connect H1x1_ DepVar;
*;
initial inest= EMWS8.AutoNeural27_ESTDS bylabel;
train tech=none;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural27\SCORECODE.sas"
group=AutoNeural27
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural27\RESIDUALSCORECODE.sas"
group=AutoNeural27
residual
;
;
...
outfit=WORK.FIT1
role=TRAIN
outkey=EMWS8.AutoNeural27_OUTKEY;
...
set EMWS8.AutoNeural27_ESTDS;
run;
proc sort;
by _name_;
run;
proc transpose data=tempweight out=EMWS8.AutoNeural27_WEIGHTS;
by _name_;
run;
data EMWS8.AutoNeural27_WEIGHTS;
set EMWS8.AutoNeural27_WEIGHTS;
