*------------------------------------------------------------*;
* Ensmbl43: Combine model for DepVar;
*------------------------------------------------------------*;
* Ensmbl43: Scoring Code of model 1 of 3;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
...
*------------------------------------------------------------*;
* Ensmbl43: Scoring Code of model 2 of 3;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl43: Scoring Code of model 3 of 3;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl43: Maximum Posteriors of 3 models;
*------------------------------------------------------------*;
_psum = 0;
...
_psum + P_DepVar0;
*------------------------------------------------------------*;
* Ensmbl43: Computing Classification Vars;
*------------------------------------------------------------*;
length I_DepVar $32;
label I_DepVar = 'Into: DepVar';
length _format $200;
...
*------------------------------------------------------------*;
* Ensmbl43: Producing Unformatted variable;
*------------------------------------------------------------*;
label U_DepVar = "Unnormalized Into: DepVar";
...
*------------------------------------------------------------*;
* Ensmbl43: Computing _WARN_ Variable;
*------------------------------------------------------------*;
length _WARN_ $4;
label _WARN_ = 'Warnings';
_WARN_ = '';
...
*------------------------------------------------------------*;
* Ensmbl43: Computing Residual Vars;
*------------------------------------------------------------*;
if
F_DepVar NE '1'
AND F_DepVar NE '0'
