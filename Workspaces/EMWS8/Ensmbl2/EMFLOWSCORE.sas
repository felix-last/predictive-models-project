*------------------------------------------------------------*;
* Ensmbl2: Combine model for DepVar;
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 1 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
...
***  Effect: PC_1 ;
_TEMP = PC_1 ;
_LP0 = _LP0 + (    0.14664303107773 * _TEMP);

***  Effect: PC_10 ;
_TEMP = PC_10 ;
_LP0 = _LP0 + (   -0.35717371836774 * _TEMP);

***  Effect: PC_11 ;
_TEMP = PC_11 ;
_LP0 = _LP0 + (     0.1174893514656 * _TEMP);

***  Effect: PC_13 ;
_TEMP = PC_13 ;
_LP0 = _LP0 + (   -0.57052471510873 * _TEMP);

***  Effect: PC_14 ;
_TEMP = PC_14 ;
_LP0 = _LP0 + (    0.23575194613408 * _TEMP);

***  Effect: PC_15 ;
_TEMP = PC_15 ;
_LP0 = _LP0 + (   -0.14664093609569 * _TEMP);

***  Effect: PC_16 ;
_TEMP = PC_16 ;
_LP0 = _LP0 + (    0.15322920312952 * _TEMP);

***  Effect: PC_17 ;
_TEMP = PC_17 ;
_LP0 = _LP0 + (   -0.07661037751667 * _TEMP);

***  Effect: PC_2 ;
_TEMP = PC_2 ;
_LP0 = _LP0 + (   -0.27300942967757 * _TEMP);

***  Effect: PC_3 ;
_TEMP = PC_3 ;
_LP0 = _LP0 + (   -0.05543884200611 * _TEMP);

***  Effect: PC_4 ;
_TEMP = PC_4 ;
_LP0 = _LP0 + (    0.07996507808131 * _TEMP);

***  Effect: PC_5 ;
_TEMP = PC_5 ;
_LP0 = _LP0 + (   -0.19902633323396 * _TEMP);

***  Effect: PC_6 ;
_TEMP = PC_6 ;
_LP0 = _LP0 + (    0.09311358379073 * _TEMP);

***  Effect: PC_7 ;
_TEMP = PC_7 ;
_LP0 = _LP0 + (    0.07957079613917 * _TEMP);

***  Effect: PC_8 ;
_TEMP = PC_8 ;
_LP0 = _LP0 + (    0.18022584834429 * _TEMP);

***  Effect: PC_9 ;
_TEMP = PC_9 ;
_LP0 = _LP0 + (    0.25420463058389 * _TEMP);

*** Naive Posterior Probabilities;
drop _MAXP _IY _P0 _P1;
_P0 = probnorm((    -1.5383593224992) + _LP0);
_P1 = 1.0 - _P0;
...
*************************************;
* Renaming variables for Reg6;
*------------------------------------------------------------*;
* Renaming Posterior variables for Reg6;
*------------------------------------------------------------*;
drop Reg6_P_DepVar1;
Reg6_P_DepVar1 = P_DepVar1;
drop Reg6_P_DepVar0;
Reg6_P_DepVar0 = P_DepVar0;
*------------------------------------------------------------*;
* Renaming _WARN_ variable for Reg6;
*------------------------------------------------------------*;
length Reg6_WARN_ $4;
drop Reg6_WARN_;
Reg6_WARN_ = _WARN_;
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 2 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Regression;
* TYPE: MODEL;
...
Reg2_WARN_ = _WARN_;
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 3 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Decision Tree;
* TYPE: MODEL;
...
Tree2_WARN_ = _WARN_;
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 4 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 5 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 6 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 7 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 8 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 9 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl2: Scoring Code of model 10 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
