*------------------------------------------------------------*;
* Ensmbl29: Combine model for DepVar;
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 1 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
...
*------------------------------------------------------------*;
* Renaming Into variables for Reg5;
*------------------------------------------------------------*;
length Reg5_I_DepVar $32;
drop Reg5_I_DepVar;
Reg5_I_DepVar = I_DepVar;
*------------------------------------------------------------*;
...
Reg5_WARN_ = _WARN_;
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 2 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Regression;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Renaming Into variables for Reg;
*------------------------------------------------------------*;
length Reg_I_DepVar $32;
drop Reg_I_DepVar;
Reg_I_DepVar = I_DepVar;
*------------------------------------------------------------*;
...
Reg_WARN_ = _WARN_;
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 3 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Decision Tree;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Renaming Into variables for Tree;
*------------------------------------------------------------*;
length Tree_I_DepVar $32;
drop Tree_I_DepVar;
Tree_I_DepVar = I_DepVar;
*------------------------------------------------------------*;
...
Tree_WARN_ = _WARN_;
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 4 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Renaming Into variables for Neural4;
*------------------------------------------------------------*;
length Neural4_I_DepVar $32;
drop Neural4_I_DepVar;
Neural4_I_DepVar = I_DepVar;
*------------------------------------------------------------*;
...
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 5 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*** *************************;
IF _DM_BAD EQ 0 THEN DO;
   H11  =     0.21197486042877 * S_AcceptedCmpTotal  +    -0.02949522070573 *
        S_Age  +    -0.16919312615037 * S_Frq  +     0.14522255331039 *
        S_Income  +     -0.0266473959975 * S_Kidhome
          +     0.00778892787353 * S_Mnt  +    -0.04773629470954 *
        S_MntFishProducts  +    -0.04230043327825 * S_MntFruits
          +     0.00794218138067 * S_MntGoldProds  +      0.2107009197796 *
        S_MntMeatProducts  +    -0.02357514913511 * S_MntSweetProducts
          +    -0.19324648510173 * S_MntWines  +    -0.01985289349376 *
        S_MonthsAsCustomer  +     0.28120382833347 * S_NumCatalogPurchases
          +     0.15204082764648 * S_NumDealsPurchases
          +     0.06913395421701 * S_NumDistPurchases
          +    -0.06320045391889 * S_NumStorePurchases
          +    -0.10763219134397 * S_NumWebPurchases
          +     0.30129325870073 * S_NumWebVisitsMonth
          +      0.0486741214698 * S_RFMstat  +     0.05669529576559 *
        S_RMntFrq  +    -0.33977590725175 * S_Recency
          +    -0.07911174205052 * S_Teenhome ;
   H11  = H11  +    -0.00076888633638 * AcceptedCmp10
          +     0.00331144478287 * AcceptedCmp20  +    -0.01959880328373 *
        AcceptedCmp30  +     0.01506573257273 * AcceptedCmp40
          +     -0.0677799414781 * AcceptedCmp50  +     0.04559602713799 *
        Complain0  +    -0.02207878651679 * HigherEducationBinary0 ;
   H11  = H11  +     0.02201277166891 * Education2n_Cycle
          +    -0.04148038680327 * EducationBasic  +     0.02074941779593 *
        EducationGraduation  +    -0.00113068890412 * EducationMaster
          +     0.03231190657829 * Marital_StatusDivorced
          +    -0.11915392851312 * Marital_StatusMarried
          +     0.09075278174727 * Marital_StatusSingle
          +    -0.12491280689858 * Marital_StatusTogether ;
   H11  =    -0.51532097089609 + H11 ;
   H11  = TANH(H11 );
END;
ELSE DO;
   H11  = .;
...
IF _DM_BAD EQ 0 THEN DO;
   P_DepVar1  =     8.82153759949468 * H11 ;
   P_DepVar1  =    -0.58718093717937 + P_DepVar1 ;
   P_DepVar0  = 0;
   _MAX_ = MAX (P_DepVar1 , P_DepVar0 );
   _SUM_ = 0.;
   P_DepVar1  = EXP(P_DepVar1  - _MAX_);
...
*------------------------------------------------------------*;
* Renaming Into variables for Neural;
*------------------------------------------------------------*;
length Neural_I_DepVar $32;
drop Neural_I_DepVar;
Neural_I_DepVar = I_DepVar;
*------------------------------------------------------------*;
...
Neural_WARN_ = _WARN_;
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 6 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 7 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 8 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Renaming Into variables for Neural7;
*------------------------------------------------------------*;
length Neural7_I_DepVar $32;
drop Neural7_I_DepVar;
Neural7_I_DepVar = I_DepVar;
*------------------------------------------------------------*;
...
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 9 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl29: Scoring Code of model 10 of 10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl29: Computing Residual Vars;
*------------------------------------------------------------*;
if
F_DepVar NE '1'
AND F_DepVar NE '0'
