*------------------------------------------------------------*;
* AutoNeural18: Create decision matrix;
*------------------------------------------------------------*;
data WORK.DepVar;
  length   DepVar                           $  32
           COUNT                                8
...
run;
*------------------------------------------------------------* ;
* AutoNeural18: DMDBClass Macro ;
*------------------------------------------------------------* ;
%macro DMDBClass;
    DepVar(DESC)
%mend DMDBClass;
*------------------------------------------------------------* ;
* AutoNeural18: DMDBVar Macro ;
*------------------------------------------------------------* ;
%macro DMDBVar;
...
%mend DMDBVar;
*------------------------------------------------------------*;
* AutoNeural18: Create DMDB;
*------------------------------------------------------------*;
proc dmdb batch data=WORK.EM_AutoNeural18
dmdbcat=WORK.AutoNeural18_DMDB
maxlevel = 513
;
class %DMDBClass;
var %DMDBVar;
...
quit;
*------------------------------------------------------------* ;
* AutoNeural18: Interval Inputs Macro ;
*------------------------------------------------------------* ;
%macro INTINPUTS;
    PC_1 PC_10 PC_11 PC_12 PC_13 PC_14 PC_15 PC_16 PC_17 PC_2 PC_3 PC_4 PC_5 PC_6
   PC_7 PC_8 PC_9 Year_Birth
%mend INTINPUTS;
*------------------------------------------------------------* ;
* AutoNeural18: Binary Inputs Macro ;
*------------------------------------------------------------* ;
%macro BININPUTS;

%mend BININPUTS;
*------------------------------------------------------------* ;
* AutoNeural18: Nominal Inputs Macro ;
*------------------------------------------------------------* ;
%macro NOMINPUTS;

%mend NOMINPUTS;
*------------------------------------------------------------* ;
* AutoNeural18: Ordinal Inputs Macro ;
*------------------------------------------------------------* ;
%macro ORDINPUTS;
...
*------------------------------------------------------------*;
*;
proc neural data=EM_AutoNeural18 dmdbcat=WORK.AutoNeural18_DMDB
...
run;
*;
data EMWS8.AutoNeural18_OUTFIT;
set _anfit;
...
proc print data=EMWS8.AutoNeural18_OUTFIT noobs;
var _iter_ _aic_ _averr_ _misc_
_vaverr_ _vmisc_
;
run;
...
data EMWS8.AutoNeural18_HISTORY;
...
*;
initial
inest = EMWS8.AutoNeural18_ESTDS bylabel;
;
*;
title9 " ";
...
prelim 18 outest=_anpre pretime=49 preiter=25
tech = Default
inest = EMWS8.AutoNeural18_ESTDS bylabel
;
*;
...
prelim 18 outest=_anpre pretime=48 preiter=25
tech = Default
inest = EMWS8.AutoNeural18_ESTDS bylabel
;
*;
...
prelim 21 outest=_anpre pretime=41 preiter=25
tech = Default
inest = EMWS8.AutoNeural18_ESTDS bylabel
;
*;
...
train estiter=1 outest=_anest outfit=_anfit maxtime=851 maxiter=50
tech = Default;
;
run;
*;
...
prelim 21 outest=_anpre pretime=40 preiter=25
tech = Default
inest = EMWS8.AutoNeural18_ESTDS bylabel
;
*;
...
train estiter=1 outest=_anest outfit=_anfit maxtime=841 maxiter=5
tech = Default;
;
run;
*;
...
connect H4x1_ DepVar;
*;
initial inest= EMWS8.AutoNeural18_ESTDS bylabel;
train tech=none;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural18\SCORECODE.sas"
group=AutoNeural18
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural18\RESIDUALSCORECODE.sas"
group=AutoNeural18
residual
;
;
...
outfit=WORK.FIT1
role=TRAIN
outkey=EMWS8.AutoNeural18_OUTKEY;
...
set EMWS8.AutoNeural18_ESTDS;
run;
proc sort;
by _name_;
run;
proc transpose data=tempweight out=EMWS8.AutoNeural18_WEIGHTS;
by _name_;
run;
data EMWS8.AutoNeural18_WEIGHTS;
set EMWS8.AutoNeural18_WEIGHTS;
