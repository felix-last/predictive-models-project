...
train estiter=1 outest=_anest outfit=_anfit maxtime=832 maxiter=50
tech = Default;
;
run;
*;
...
train estiter=1 outest=_anest outfit=_anfit maxtime=802 maxiter=50
tech = Default;
;
run;
*;
...
prelim 20 outest=_anpre pretime=39 preiter=25
tech = Default
inest = EMWS8.AutoNeural26_ESTDS bylabel
;
*;
...
train estiter=1 outest=_anest outfit=_anfit maxtime=786 maxiter=5
tech = Default;
;
run;
*;
