...
train tech=NONE;
code file="C:\\predictive-models-project\Workspaces\EMWS8\Neural4\SCORECODE.sas"
group=Neural4
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\Neural4\RESIDUALSCORECODE.sas"
group=Neural4
residual
;
;
