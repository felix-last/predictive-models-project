...
Prelim 5 preiter=10
pretime=3600
Outest=EMWS8.Neural11_PRELIM_OUTEST
;
save network=EMWS8.Neural11_NETWORK.dm_neural;
train Maxiter=50
maxtime=14400
Outest=EMWS8.Neural11_outest estiter=1
Outfit=EMWS8.Neural11_OUTFIT
;
run;
quit;
proc sort data=EMWS8.Neural11_OUTFIT(where=(_iter_ ne . and _NAME_="OVERALL")) out=fit_Neural11;
by _VAVERR_;
run;
%GLOBAL ITER;
data _null_;
...
run;
data EMWS8.Neural11_INITIAL;
set EMWS8.Neural11_outest(where=(_ITER_ eq &ITER and _OBJ_ ne .));
run;
*------------------------------------------------------------*;
...
proc neural data=EM_Neural11 dmdbcat=WORK.Neural11_DMDB
validdata = EMWS8.PRINCOMP_VALIDATE
network = EMWS8.Neural11_NETWORK.dm_neural
random=12345
;
nloptions noprint;
performance alldetails noutilfile;
initial inest=EMWS8.Neural11_INITIAL;
train tech=NONE;
code file="C:\\predictive-models-project\Workspaces\EMWS8\Neural11\SCORECODE.sas"
group=Neural11
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\Neural11\RESIDUALSCORECODE.sas"
group=Neural11
residual
;
;
...
run;
quit;
data EMWS8.Neural11_OUTFIT;
merge WORK.FIT1 WORK.FIT2;
run;
data EMWS8.Neural11_EMESTIMATE;
set EMWS8.Neural11_outest;
