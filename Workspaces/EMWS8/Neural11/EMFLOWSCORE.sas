...
*** *************************;
IF _DM_BAD EQ 0 THEN DO;
   H11  =    -0.10779848418181 * S_PC_1  +     0.09315986878639 * S_PC_10
          +    -0.03602343723016 * S_PC_11  +    -0.02214286994284 * S_PC_12
          +      0.1463819191836 * S_PC_13  +    -0.06057500684726 * S_PC_14
          +     0.04003057615401 * S_PC_15  +    -0.03171221434661 * S_PC_16
          +     0.01959009419309 * S_PC_17  +     0.10171257983407 * S_PC_2
          +     0.02117202187974 * S_PC_3  +    -0.02609959549496 * S_PC_4
          +     0.06274377685426 * S_PC_5  +    -0.02936526023354 * S_PC_6
          +    -0.01853862761408 * S_PC_7  +    -0.04891455650107 * S_PC_8
          +    -0.06547184427141 * S_PC_9  +    -0.00614630950598 *
        S_Year_Birth ;
   H11  =    -0.80299655741874 + H11 ;
   H11  = TANH(H11 );
END;
ELSE DO;
   H11  = .;
...
IF _DM_BAD EQ 0 THEN DO;
   P_DepVar1  =    -20.6561051767535 * H11 ;
   P_DepVar1  =    -16.6085807379215 + P_DepVar1 ;
   P_DepVar0  = 0;
