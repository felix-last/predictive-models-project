...
prelim 16 outest=_anpre pretime=53 preiter=25
tech = Default
inest = EMWS8.AutoNeural9_ESTDS bylabel
;
*;
...
prelim 16 outest=_anpre pretime=52 preiter=25
tech = Default
inest = EMWS8.AutoNeural9_ESTDS bylabel
;
*;
...
train estiter=1 outest=_anest outfit=_anfit maxtime=843 maxiter=5
tech = Default;
;
run;
*;
