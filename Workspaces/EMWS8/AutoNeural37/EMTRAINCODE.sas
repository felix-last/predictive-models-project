*------------------------------------------------------------*;
* AutoNeural37: Create decision matrix;
*------------------------------------------------------------*;
data WORK.DepVar;
  length   DepVar                           $  32
           COUNT                                8
...
%mend DMDBVar;
*------------------------------------------------------------*;
* AutoNeural37: Create DMDB;
*------------------------------------------------------------*;
proc dmdb batch data=WORK.EM_AutoNeural37
dmdbcat=WORK.AutoNeural37_DMDB
maxlevel = 513
;
class %DMDBClass;
var %DMDBVar;
...
quit;
*------------------------------------------------------------* ;
* AutoNeural37: Interval Inputs Macro ;
*------------------------------------------------------------* ;
%macro INTINPUTS;
    AcceptedCmpTotal Age Frq Income Kidhome MntFishProducts MntFruits MntGoldProds
   MntSweetProducts MonthsAsCustomer NumDealsPurchases NumWebVisitsMonth RFMstat
...
%mend INTINPUTS;
*------------------------------------------------------------* ;
* AutoNeural37: Binary Inputs Macro ;
*------------------------------------------------------------* ;
%macro BININPUTS;
...
%mend BININPUTS;
*------------------------------------------------------------* ;
* AutoNeural37: Nominal Inputs Macro ;
*------------------------------------------------------------* ;
%macro NOMINPUTS;
    Education Marital_Status
%mend NOMINPUTS;
*------------------------------------------------------------* ;
* AutoNeural37: Ordinal Inputs Macro ;
*------------------------------------------------------------* ;
%macro ORDINPUTS;
...
*------------------------------------------------------------*;
*;
proc neural data=EM_AutoNeural37 dmdbcat=WORK.AutoNeural37_DMDB
...
run;
*;
data EMWS8.AutoNeural37_OUTFIT;
set _anfit;
...
proc print data=EMWS8.AutoNeural37_OUTFIT noobs;
var _iter_ _aic_ _averr_ _misc_
_vaverr_ _vmisc_
;
run;
...
data EMWS8.AutoNeural37_HISTORY;
...
*;
initial
inest = EMWS8.AutoNeural37_ESTDS bylabel;
;
*;
title9 " ";
...
train estiter=1 outest=_anest outfit=_anfit maxtime=887 maxiter=5
tech = Default;
;
run;
*;
...
connect H3x1_ DepVar;
*;
initial inest= EMWS8.AutoNeural37_ESTDS bylabel;
train tech=none;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural37\SCORECODE.sas"
group=AutoNeural37
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural37\RESIDUALSCORECODE.sas"
group=AutoNeural37
residual
;
;
...
outfit=WORK.FIT1
role=TRAIN
outkey=EMWS8.AutoNeural37_OUTKEY;
...
set EMWS8.AutoNeural37_ESTDS;
run;
proc sort;
by _name_;
run;
proc transpose data=tempweight out=EMWS8.AutoNeural37_WEIGHTS;
by _name_;
run;
data EMWS8.AutoNeural37_WEIGHTS;
set EMWS8.AutoNeural37_WEIGHTS;
