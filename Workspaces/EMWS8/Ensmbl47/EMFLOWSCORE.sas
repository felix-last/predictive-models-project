*------------------------------------------------------------*;
* Ensmbl47: Combine model for DepVar;
*------------------------------------------------------------*;
* Ensmbl47: Scoring Code of model 1 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
...
*------------------------------------------------------------*;
* Ensmbl47: Scoring Code of model 2 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl47: Scoring Code of model 3 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl47: Scoring Code of model 4 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl47: Scoring Code of model 5 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl47: Voting to produce predicted target;
*------------------------------------------------------------*;
array Ensmbl47_post{2} _temporary_;
array Ensmbl47_count{2} _temporary_;
array Ensmbl47_level{2} $32 _temporary_ (
"1"
"0"
);
do i=1 to 2;
...
if AutoNeural9_I_DepVar = Ensmbl47_level{1} then do;
Ensmbl47_count{1} + 1;
Ensmbl47_post{1}=Ensmbl47_post{1}+ AutoNeural9_P_DepVar1;
end;
if AutoNeural11_I_DepVar = Ensmbl47_level{1} then do;
Ensmbl47_count{1} + 1;
Ensmbl47_post{1}=Ensmbl47_post{1}+ AutoNeural11_P_DepVar1;
end;
if AutoNeural12_I_DepVar = Ensmbl47_level{1} then do;
Ensmbl47_count{1} + 1;
Ensmbl47_post{1}=Ensmbl47_post{1}+ AutoNeural12_P_DepVar1;
end;
if AutoNeural7_I_DepVar = Ensmbl47_level{1} then do;
Ensmbl47_count{1} + 1;
Ensmbl47_post{1}=Ensmbl47_post{1}+ AutoNeural7_P_DepVar1;
end;
if AutoNeural10_I_DepVar = Ensmbl47_level{1} then do;
Ensmbl47_count{1} + 1;
Ensmbl47_post{1}=Ensmbl47_post{1}+ AutoNeural10_P_DepVar1;
end;
if AutoNeural9_I_DepVar = Ensmbl47_level{2} then do;
Ensmbl47_count{2} + 1;
Ensmbl47_post{2}=Ensmbl47_post{2}+ AutoNeural9_P_DepVar0;
end;
if AutoNeural11_I_DepVar = Ensmbl47_level{2} then do;
Ensmbl47_count{2} + 1;
Ensmbl47_post{2}=Ensmbl47_post{2}+ AutoNeural11_P_DepVar0;
end;
if AutoNeural12_I_DepVar = Ensmbl47_level{2} then do;
Ensmbl47_count{2} + 1;
Ensmbl47_post{2}=Ensmbl47_post{2}+ AutoNeural12_P_DepVar0;
end;
if AutoNeural7_I_DepVar = Ensmbl47_level{2} then do;
Ensmbl47_count{2} + 1;
Ensmbl47_post{2}=Ensmbl47_post{2}+ AutoNeural7_P_DepVar0;
end;
if AutoNeural10_I_DepVar = Ensmbl47_level{2} then do;
Ensmbl47_count{2} + 1;
Ensmbl47_post{2}=Ensmbl47_post{2}+ AutoNeural10_P_DepVar0;
end;
*------------------------------------------------------------*;
* Ensmbl47: Determine Into Variable;
*------------------------------------------------------------*;
length I_DepVar $32;
...
do i=1 to 2;
if Ensmbl47_count{i}=vote_count and Ensmbl47_post{i}>vote_post then do;
I_DepVar = Ensmbl47_level{i};
vote_post = Ensmbl47_count{i};
end;
end;
*------------------------------------------------------------*;
* Ensmbl47: Compute posterior vars using models predicting the chosen level;
*------------------------------------------------------------*;
P_DepVar1 = 0;
P_DepVar0 = 0;
...
* Ensmbl47: Averaging posterior;
P_DepVar1 = P_DepVar1/vote_count;
P_DepVar0 = P_DepVar0/vote_count;
*------------------------------------------------------------*;
* Ensmbl47: Producing Unformatted variable;
*------------------------------------------------------------*;
label U_DepVar = "Unnormalized Into: DepVar";
...
*------------------------------------------------------------*;
* Ensmbl47: Computing _WARN_ Variable;
*------------------------------------------------------------*;
length _WARN_ $4;
label _WARN_ = 'Warnings';
_WARN_ = '';
...
*------------------------------------------------------------*;
* Ensmbl47: Computing Residual Vars;
*------------------------------------------------------------*;
if
F_DepVar NE '1'
AND F_DepVar NE '0'
