...
CatPurchase DepVar Frq G_Education G_Marital_Status Income Mnt RMntFrq_Exmpl2
Recomendation );
run;
*------------------------------------------------------------* ;
...
*------------------------------------------------------------* ;
%macro DMDBClass;
    DepVar(DESC) G_Education(ASC) G_Marital_Status(ASC)
%mend DMDBClass;
*------------------------------------------------------------* ;
* Neural6: DMDBVar Macro ;
*------------------------------------------------------------* ;
%macro DMDBVar;
    CatPurchase Frq Income Mnt RMntFrq_Exmpl2 Recomendation
%mend DMDBVar;
*------------------------------------------------------------*;
* Neural6: Create DMDB;
*------------------------------------------------------------*;
...
train tech=NONE;
code file="E:\DataMining_EMProjects\Tugas\Workspaces\EMWS8\Neural6\SCORECODE.sas"
group=Neural6
;
;
code file="E:\DataMining_EMProjects\Tugas\Workspaces\EMWS8\Neural6\RESIDUALSCORECODE.sas"
group=Neural6
residual
;
;
