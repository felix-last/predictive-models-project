...
train estiter=1 outest=_anest outfit=_anfit maxtime=868 maxiter=5
tech = Default;
;
run;
*;
...
connect H1x1_ DepVar;
*;
initial inest= EMWS8.AutoNeural36_ESTDS bylabel;
train tech=none;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural36\SCORECODE.sas"
group=AutoNeural36
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural36\RESIDUALSCORECODE.sas"
group=AutoNeural36
residual
;
;
...
outfit=WORK.FIT1
role=TRAIN
outkey=EMWS8.AutoNeural36_OUTKEY;
...
set EMWS8.AutoNeural36_ESTDS;
run;
proc sort;
by _name_;
run;
proc transpose data=tempweight out=EMWS8.AutoNeural36_WEIGHTS;
by _name_;
run;
data EMWS8.AutoNeural36_WEIGHTS;
set EMWS8.AutoNeural36_WEIGHTS;
