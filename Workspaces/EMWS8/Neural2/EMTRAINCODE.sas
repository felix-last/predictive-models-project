...
Prelim 5 preiter=10
pretime=3600
Outest=EMWS8.Neural2_PRELIM_OUTEST
;
save network=EMWS8.Neural2_NETWORK.dm_neural;
train Maxiter=50
maxtime=14400
Outest=EMWS8.Neural2_outest estiter=1
Outfit=EMWS8.Neural2_OUTFIT
;
run;
quit;
proc sort data=EMWS8.Neural2_OUTFIT(where=(_iter_ ne . and _NAME_="OVERALL")) out=fit_Neural2;
by _VAVERR_;
run;
%GLOBAL ITER;
data _null_;
...
run;
data EMWS8.Neural2_INITIAL;
set EMWS8.Neural2_outest(where=(_ITER_ eq &ITER and _OBJ_ ne .));
run;
*------------------------------------------------------------*;
...
proc neural data=EM_Neural2 dmdbcat=WORK.Neural2_DMDB
validdata = EMWS8.Meta_VALIDATE
network = EMWS8.Neural2_NETWORK.dm_neural
random=12345
;
nloptions noprint;
performance alldetails noutilfile;
initial inest=EMWS8.Neural2_INITIAL;
train tech=NONE;
code file="E:\DataMining_EMProjects\Tugas\Workspaces\EMWS8\Neural2\SCORECODE.sas"
group=Neural2
;
;
code file="E:\DataMining_EMProjects\Tugas\Workspaces\EMWS8\Neural2\RESIDUALSCORECODE.sas"
group=Neural2
residual
;
;
...
run;
quit;
data EMWS8.Neural2_OUTFIT;
merge WORK.FIT1 WORK.FIT2;
run;
data EMWS8.Neural2_EMESTIMATE;
set EMWS8.Neural2_outest;
