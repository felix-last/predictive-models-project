*------------------------------------------------------------*;
* AutoNeural44: Create decision matrix;
*------------------------------------------------------------*;
data WORK.DepVar;
  length   DepVar                           $  32
           COUNT                                8
...
%mend DMDBVar;
*------------------------------------------------------------*;
* AutoNeural44: Create DMDB;
*------------------------------------------------------------*;
proc dmdb batch data=WORK.EM_AutoNeural44
dmdbcat=WORK.AutoNeural44_DMDB
maxlevel = 513
;
class %DMDBClass;
var %DMDBVar;
...
quit;
*------------------------------------------------------------* ;
* AutoNeural44: Interval Inputs Macro ;
*------------------------------------------------------------* ;
%macro INTINPUTS;
    Income Kidhome MntFishProducts MntFruits MntGoldProds MntMeatProducts
   MntSweetProducts MntWines NumCatalogPurchases NumDealsPurchases
...
%mend INTINPUTS;
*------------------------------------------------------------* ;
* AutoNeural44: Binary Inputs Macro ;
*------------------------------------------------------------* ;
%macro BININPUTS;
    AcceptedCmp1 AcceptedCmp2 AcceptedCmp3 AcceptedCmp4 AcceptedCmp5 Complain
%mend BININPUTS;
*------------------------------------------------------------* ;
* AutoNeural44: Nominal Inputs Macro ;
*------------------------------------------------------------* ;
%macro NOMINPUTS;
    Education Marital_Status
%mend NOMINPUTS;
*------------------------------------------------------------* ;
* AutoNeural44: Ordinal Inputs Macro ;
*------------------------------------------------------------* ;
%macro ORDINPUTS;
...
*------------------------------------------------------------*;
*;
proc neural data=EM_AutoNeural44 dmdbcat=WORK.AutoNeural44_DMDB
...
run;
*;
data EMWS8.AutoNeural44_OUTFIT;
set _anfit;
...
proc print data=EMWS8.AutoNeural44_OUTFIT noobs;
var _iter_ _aic_ _averr_ _misc_
_vaverr_ _vmisc_
;
run;
...
data EMWS8.AutoNeural44_HISTORY;
...
*;
initial
inest = EMWS8.AutoNeural44_ESTDS bylabel;
;
*;
title9 " ";
...
connect H3x1_ DepVar;
*;
initial inest= EMWS8.AutoNeural44_ESTDS bylabel;
train tech=none;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural44\SCORECODE.sas"
group=AutoNeural44
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural44\RESIDUALSCORECODE.sas"
group=AutoNeural44
residual
;
;
...
outfit=WORK.FIT1
role=TRAIN
outkey=EMWS8.AutoNeural44_OUTKEY;
...
set EMWS8.AutoNeural44_ESTDS;
run;
proc sort;
by _name_;
run;
proc transpose data=tempweight out=EMWS8.AutoNeural44_WEIGHTS;
by _name_;
run;
data EMWS8.AutoNeural44_WEIGHTS;
set EMWS8.AutoNeural44_WEIGHTS;
