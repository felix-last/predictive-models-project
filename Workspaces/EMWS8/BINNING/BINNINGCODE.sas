...
if MonthsAsCustomer < 69 then BIN_MonthsAsCustomer=1;
else if MonthsAsCustomer < 83 then BIN_MonthsAsCustomer=2;
else if MonthsAsCustomer < 98 then BIN_MonthsAsCustomer=3;
else if MonthsAsCustomer >= 98 then BIN_MonthsAsCustomer=4;
end;
