*------------------------------------------------------------*;
* Ensmbl32: Combine model for DepVar;
*------------------------------------------------------------*;
* Ensmbl32: Scoring Code of model 1 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
...
*------------------------------------------------------------*;
* Ensmbl32: Scoring Code of model 2 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl32: Scoring Code of model 3 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl32: Scoring Code of model 4 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: AutoNeural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl32: Scoring Code of model 5 of 5;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
if AutoNeural7_I_DepVar = Ensmbl32_level{1} then do;
Ensmbl32_count{1} + 1;
Ensmbl32_post{1}=Ensmbl32_post{1}+ AutoNeural7_P_DepVar1;
end;
if AutoNeural9_I_DepVar = Ensmbl32_level{1} then do;
Ensmbl32_count{1} + 1;
Ensmbl32_post{1}=Ensmbl32_post{1}+ AutoNeural9_P_DepVar1;
end;
if AutoNeural12_I_DepVar = Ensmbl32_level{1} then do;
Ensmbl32_count{1} + 1;
Ensmbl32_post{1}=Ensmbl32_post{1}+ AutoNeural12_P_DepVar1;
end;
if AutoNeural11_I_DepVar = Ensmbl32_level{1} then do;
Ensmbl32_count{1} + 1;
Ensmbl32_post{1}=Ensmbl32_post{1}+ AutoNeural11_P_DepVar1;
end;
if Neural3_I_DepVar = Ensmbl32_level{1} then do;
Ensmbl32_count{1} + 1;
Ensmbl32_post{1}=Ensmbl32_post{1}+ Neural3_P_DepVar1;
end;
if AutoNeural7_I_DepVar = Ensmbl32_level{2} then do;
Ensmbl32_count{2} + 1;
Ensmbl32_post{2}=Ensmbl32_post{2}+ AutoNeural7_P_DepVar0;
end;
if AutoNeural9_I_DepVar = Ensmbl32_level{2} then do;
Ensmbl32_count{2} + 1;
Ensmbl32_post{2}=Ensmbl32_post{2}+ AutoNeural9_P_DepVar0;
end;
if AutoNeural12_I_DepVar = Ensmbl32_level{2} then do;
Ensmbl32_count{2} + 1;
Ensmbl32_post{2}=Ensmbl32_post{2}+ AutoNeural12_P_DepVar0;
end;
if AutoNeural11_I_DepVar = Ensmbl32_level{2} then do;
Ensmbl32_count{2} + 1;
Ensmbl32_post{2}=Ensmbl32_post{2}+ AutoNeural11_P_DepVar0;
end;
...
*------------------------------------------------------------*;
* Ensmbl32: Computing Residual Vars;
*------------------------------------------------------------*;
if
F_DepVar NE '1'
AND F_DepVar NE '0'
