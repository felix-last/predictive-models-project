*------------------------------------------------------------*;
* Neural18: Create decision matrix;
*------------------------------------------------------------*;
data WORK.DepVar;
  length   DepVar                           $  32
           COUNT                                8
...
*------------------------------------------------------------*;
proc dmdb batch data=WORK.EM_Neural18
dmdbcat=WORK.Neural18_DMDB
maxlevel = 513
;
class %DMDBClass;
var %DMDBVar;
...
;
*------------------------------------------------------------*;
proc neural data=EM_Neural18 dmdbcat=WORK.Neural18_DMDB
...
Prelim 5 preiter=10
pretime=3600
Outest=EMWS8.Neural18_PRELIM_OUTEST
;
save network=EMWS8.Neural18_NETWORK.dm_neural;
train Maxiter=50
maxtime=14400
Outest=EMWS8.Neural18_outest estiter=1
Outfit=EMWS8.Neural18_OUTFIT
;
run;
quit;
proc sort data=EMWS8.Neural18_OUTFIT(where=(_iter_ ne . and _NAME_="OVERALL")) out=fit_Neural18;
by _VAVERR_;
run;
%GLOBAL ITER;
data _null_;
set fit_Neural18(obs=1);
call symput('ITER',put(_ITER_, 6.));
run;
data EMWS8.Neural18_INITIAL;
set EMWS8.Neural18_outest(where=(_ITER_ eq &ITER and _OBJ_ ne .));
run;
*------------------------------------------------------------*;
...
proc neural data=EM_Neural18 dmdbcat=WORK.Neural18_DMDB
validdata = EMWS8.BINNING_VALIDATE
network = EMWS8.Neural18_NETWORK.dm_neural
random=12345
;
nloptions noprint;
performance alldetails noutilfile;
initial inest=EMWS8.Neural18_INITIAL;
train tech=NONE;
code file="C:\\predictive-models-project\Workspaces\EMWS8\Neural18\SCORECODE.sas"
group=Neural18
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\Neural18\RESIDUALSCORECODE.sas"
group=Neural18
residual
;
;
...
run;
quit;
data EMWS8.Neural18_OUTFIT;
merge WORK.FIT1 WORK.FIT2;
run;
data EMWS8.Neural18_EMESTIMATE;
set EMWS8.Neural18_outest;
