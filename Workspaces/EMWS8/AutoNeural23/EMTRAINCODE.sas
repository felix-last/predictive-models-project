*------------------------------------------------------------*;
* AutoNeural23: Create decision matrix;
*------------------------------------------------------------*;
data WORK.DepVar;
  length   DepVar                           $  32
           COUNT                                8
...
%mend DMDBVar;
*------------------------------------------------------------*;
* AutoNeural23: Create DMDB;
*------------------------------------------------------------*;
proc dmdb batch data=WORK.EM_AutoNeural23
dmdbcat=WORK.AutoNeural23_DMDB
maxlevel = 513
;
class %DMDBClass;
var %DMDBVar;
...
quit;
*------------------------------------------------------------* ;
* AutoNeural23: Interval Inputs Macro ;
*------------------------------------------------------------* ;
%macro INTINPUTS;
    Year_Birth
%mend INTINPUTS;
*------------------------------------------------------------* ;
* AutoNeural23: Binary Inputs Macro ;
*------------------------------------------------------------* ;
%macro BININPUTS;
...
data EMWS8.AutoNeural23_HISTORY;
...
train tech=none;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural23\SCORECODE.sas"
group=AutoNeural23
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\AutoNeural23\RESIDUALSCORECODE.sas"
group=AutoNeural23
residual
;
;
...
outfit=WORK.FIT1
role=TRAIN
outkey=EMWS8.AutoNeural23_OUTKEY;
...
set EMWS8.AutoNeural23_ESTDS;
run;
proc sort;
by _name_;
run;
proc transpose data=tempweight out=EMWS8.AutoNeural23_WEIGHTS;
by _name_;
run;
data EMWS8.AutoNeural23_WEIGHTS;
set EMWS8.AutoNeural23_WEIGHTS;
