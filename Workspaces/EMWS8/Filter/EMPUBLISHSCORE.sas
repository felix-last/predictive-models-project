...
and ( Kidhome ne .)
and ( MntFishProducts ne . and (MntFishProducts<=200))
and ( MntFruits ne . and (MntFruits<=157))
and ( MntGoldProds ne . and (MntGoldProds<=196))
and ( MntMeatProducts ne . and (MntMeatProducts<=964))
and ( MntSweetProducts ne . and (MntSweetProducts<=143.2))
and ( MntWines ne . and (MntWines<=1325))
