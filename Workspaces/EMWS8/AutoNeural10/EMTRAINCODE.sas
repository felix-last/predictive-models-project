...
train estiter=1 outest=_anest outfit=_anfit maxtime=826 maxiter=50
tech = Default;
;
run;
*;
...
train estiter=1 outest=_anest outfit=_anfit maxtime=807 maxiter=50
tech = Default;
;
run;
*;
...
train estiter=1 outest=_anest outfit=_anfit maxtime=769 maxiter=5
tech = Default;
;
run;
*;
