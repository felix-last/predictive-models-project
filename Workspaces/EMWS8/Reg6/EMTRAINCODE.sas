...
outest = EMWS8.Reg6_EMESTIMATE
outterms = EMWS8.Reg6_OUTTERMS
outmap= EMWS8.Reg6_MAPDS namelen=200
;
class
DepVar
;
...
;
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\Reg6\EMPUBLISHSCORE.sas"
group=Reg6
;
code file="C:\\predictive-models-project\Workspaces\EMWS8\Reg6\EMFLOWSCORE.sas"
group=Reg6
residual
;
run;
