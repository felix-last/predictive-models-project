...
%macro EM_TREETARGETS;
    DepVar
%mend EM_TREETARGETS;
data WORK.EM_Rule5 / view=WORK.EM_Rule5;
...
%mend NOMINPUTS;
*------------------------------------------------------------* ;
* Rule5: Ordinal Inputs Macro ;
*------------------------------------------------------------* ;
%macro ORDINPUTS;

%mend ORDINPUTS;
*------------------------------------------------------------*;
* Rule5: Run ARBOR procedure;
*------------------------------------------------------------*;
proc arbor data=WORK.EM_Rule5
Leafsize=50
Mincatsize = 5
Maxdepth=4
Missing=USEINSEARCH
...
residual
;
score data=EMWS8.Varsel_TRAIN out=_ptrain
;
score data=EMWS8.Varsel_VALIDATE out=_pvalid
;
run;
quit;
